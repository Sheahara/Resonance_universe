...
2. Ava Kessler (BSP)
3. Ilyana Crane, MD (Sciara's neurologist at Site-17)
4. Ava's department head (Behavioral Support oversight)

**Complaint Content:**
- Sevron interfering with BSP protocols
- Scheduling tests/appointments without proper channels
- Isolating participant from support system
- Pattern inconsistent with standard practice

**Outcome:**
- Sciara initially willing to participate
- Withdrew consent abruptly without explanation
- All complaints subsequently withdrawn
- Suspected coercion via threats to third parties

---

## Evidence Inventory (Accumulating)
...
- Trigger: Patient harm documentation
- Status: FRMC may initiate

### Civil Liability
- Jurisdiction: Personal injury
- Trigger: Patient/proxy filing
...
- **SCIARA_RECOVERY**: Medical evidence feeds case
- **SEVRON_MACHINATIONS**: Countermeasures expected
- **KESSLER_EXTRACTION**: Ava as witness/whistleblower
- **MIRA_AWAKENING**: Mira as eyewitness
